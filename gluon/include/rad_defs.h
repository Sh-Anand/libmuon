#define GPU_MEM_START_ADDR 0x1000
#define KERNEL_LOAD_ADDR 0x2000
...
#define KERNEL_HEADER_MEM_REGS_PER_THREAD (KERNEL_HEADER_MEM_PRINTF_HOST_ADDR + 4) // [52:52], 1 byte
...
#define KERNEL_HEADER_MEM_PADDING (4 - ((KERNEL_HEADER_MEM_FLAGS + 1) & 3)) // [58:59], 4 bytes of padding for 4 byte alignment
